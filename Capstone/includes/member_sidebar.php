...
<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="member_dashboard.php" class="nav-item <?= ($activePage??'') === 'dashboard' ? 'active' : '' ?>">
      <span class="nav-icon">🏠</span> Dashboard
    </a>

    <div class="nav-section-label">Loans</div>
    <a href="member_loan_apply.php" class="nav-item <?= ($activePage??'') === 'loan_apply' ? 'active' : '' ?>">
      <span class="nav-icon">📝</span> Apply for Loan
    </a>
    <a href="member_loans.php" class="nav-item <?= ($activePage??'') === 'loans' ? 'active' : '' ?>">
    ...
    <a href="member_transactions.php" class="nav-item <?= ($activePage??'') === 'transactions' ? 'active' : '' ?>">
